...
define(['app'], function (app) {
	 ...
	 var appHeaderController = function ($rootScope,$http, $scope,$location, localStorageService, constantService,navigationService,signInService,modalService) {
	   ...
	   $scope.$on('changed', function(event, userObj) {
		...
		$scope.$on('backtoprimary', function(event, userObj) {
			...
			$scope.loggedinUserInfo.secondaryRole = userObj.secondaryRole;
			 ...
			 {
			 	navigationService.menuNavigation("employeedashboard")
			 }
    ...
    app.controller('appHeaderController', ['$rootScope','$http', '$scope','$location','localStorageService','constantService','navigationService','signInService','modalService', appHeaderController]);
